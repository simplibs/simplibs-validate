...
_DESIGN_NOTES = """
# Validate Decorators Sub-Package

## Purpose
Public sub-package exporting core decorators for function argument/return
validation, dataclass field enforcement, and runtime execution logging.
