...
from simplibs.validate.decorators.validate_dataclass import validate_dataclass
...
def test_validate_dataclass_prevents_double_wrapping() -> None:
    """Verify that applying @validate_dataclass twice unwraps previous wrapper layers."""
    ...
    # Ověříme, že __init__ má správně nastavený indikátor wrapperu
    assert getattr(User.__init__, "_is_validate_dataclass_wrapper", False) is True