import pytest
from simplibs.validate.tools.validate_dataclass._helpers import get_context_string
...
def test_get_context_string_standard_class() -> None:
    """Verify context string formatting for standard classes with module and qualname."""
    result = get_context_string(DummyDataClass)
